...
internal enum Opentelemetry_Proto_Collector_Metrics_V1_MetricsService {
    ...
    internal typealias StreamingServiceProtocol = Opentelemetry_Proto_Collector_Metrics_V1_MetricsService_StreamingServiceProtocol
    @available(macOS 15.0, iOS 18.0, watchOS 11.0, tvOS 18.0, visionOS 2.0, *)
    internal typealias ServiceProtocol = Opentelemetry_Proto_Collector_Metrics_V1_MetricsService_ServiceProtocol
}
...
/// central collector.
@available(macOS 15.0, iOS 18.0, watchOS 11.0, tvOS 18.0, visionOS 2.0, *)
internal protocol Opentelemetry_Proto_Collector_Metrics_V1_MetricsService_StreamingServiceProtocol: GRPCCore.RegistrableRPCService {
...
/// central collector.
@available(macOS 15.0, iOS 18.0, watchOS 11.0, tvOS 18.0, visionOS 2.0, *)
internal protocol Opentelemetry_Proto_Collector_Metrics_V1_MetricsService_ServiceProtocol: Opentelemetry_Proto_Collector_Metrics_V1_MetricsService.StreamingServiceProtocol {
    /// For performance reasons, it is recommended to keep this RPC
    /// alive for the entire life of the application.
    func export(
...
/// Partial conformance to `Opentelemetry_Proto_Collector_Metrics_V1_MetricsService_StreamingServiceProtocol`.
@available(macOS 15.0, iOS 18.0, watchOS 11.0, tvOS 18.0, visionOS 2.0, *)
